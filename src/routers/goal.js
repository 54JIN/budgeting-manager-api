...
router.post('/financialGoals', auth, async (req, res) => {
    const goal = new Goal({
        ...req.body,
        owner: req.user._id
    })
...
router.get('/financialGoals', auth, async (req, res) => {
    try {
...
router.patch('/financialGoals/:id', auth, async (req, res) => {
...
router.delete('/financialGoals/:id', auth, async (req, res) => {
    try {
